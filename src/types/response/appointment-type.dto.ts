...
export class AppointmentTypeDto {
  ...
  @ApiProperty({ example: 1, enum: { 1: ' fixed price', 2: 'from price', 3: 'not applicable' } })
  PriceType: number;
  ...
  @ApiProperty({ example: 1, enum: { 1: 'bookable', 2: 'not bookable' }, description: 'Signals if this appointment type can be booked by consumer.' })
